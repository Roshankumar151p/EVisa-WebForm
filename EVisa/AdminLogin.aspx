<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="EVisa.AdminLogin" %>
    ...
    <div class="login-container">
        <div class="login-box">
            ...
            <form id="loginForm" runat="server">
                ...
                <asp:Button ID="btnLogin" runat="server" Text="Login" CssClass="login-btn" OnClick="btnLogin_Click1"/>
                <br />
                <br />
