<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HRFeedback.aspx.cs" Inherits="EVisa.HRFeedback" %>
        ...
        <div class="container">
            ...
            <div class="feedback-form">
                <div class="form-group">
                    <label for="txtHRID">HR ID</label>
                    <asp:TextBox ID="txtHRID" runat="server" CssClass="form-control" />
                </div>
                <div class="form-group">
